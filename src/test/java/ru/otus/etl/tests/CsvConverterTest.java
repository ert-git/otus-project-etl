...
public class CsvConverterTest {
    ...
    public void test_extractable() throws EtlException {
        URL url = Thread.currentThread().getContextClassLoader().getResource("list.csv");
    ...
    public void test_json_out() throws Exception {
        String url = Thread.currentThread().getContextClassLoader().getResource("list.csv").toString();
